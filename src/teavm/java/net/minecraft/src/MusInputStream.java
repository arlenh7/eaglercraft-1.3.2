...
class MusInputStream extends InputStream
{
    ...
    public MusInputStream(CodecMus par1CodecMus, String par2Path, InputStream par3InputStream)
    {
        this.codec = par1CodecMus;
        this.buffer = new byte[1];
        this.inputStream = par3InputStream;
        String var4 = par2Path != null ? par2Path : "";
        int lastSlash = var4.lastIndexOf("/");
        if (lastSlash >= 0)
        {
            var4 = var4.substring(lastSlash + 1);
        }
