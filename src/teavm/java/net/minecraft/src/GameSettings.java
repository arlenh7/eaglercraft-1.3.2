...
public class GameSettings
{
    ...
    private boolean webPerfApplied;
    ...
    public GameSettings(Minecraft par1Minecraft, File par2File)
    {
        ...
        this.optionsFile = new VFile2(par2File, "options.txt");
        this.loadOptions();
        this.applyWebPerfDefaultsIfNeeded();
    }
        ...
        try
        {
            ...
            while ((var2 = var1.readLine()) != null)
            {
                try
                {
                    ...
                    if (var3[0].equals("webPerfApplied"))
                    {
                        this.webPerfApplied = var3[1].equals("true");
                    }
    ...
    private void applyWebPerfDefaultsIfNeeded()
    {
        ...
        this.limitFramerate = 2;
        this.webPerfApplied = true;
        this.saveOptions();
    }
    ...
    public void saveOptions()
    {
        try
        {
            ...
            var1.println("webPerfApplied:" + this.webPerfApplied);
