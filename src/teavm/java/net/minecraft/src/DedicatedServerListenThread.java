...
public class DedicatedServerListenThread extends NetworkListenThread
{
    ...
    public DedicatedServerListenThread(MinecraftServer par1MinecraftServer, Object par2InetAddress, int par3) throws IOException
    {
    ...
    public void func_71761_a(Object par1InetAddress)
    {
