...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        addSplashesFromResource(var2, "title/splashes.txt");
        addSplashesFromResource(var2, "/title/splashes.txt");
        addSplashesFromResource(var2, "assets/minecraft/title/splashes.txt");
    ...
    private static void addSplashesFromResource(ArrayList list, String path)
    {
        java.util.List<String> lines = EagRuntime.getResourceLines(path);
        if (lines == null)
        {
            return;
        }
