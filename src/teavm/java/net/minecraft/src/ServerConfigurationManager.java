...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(NetworkManager par1NetworkManager, EntityPlayerMP par2EntityPlayerMP)
    {
        ...
        String var3 = par1NetworkManager.getSocketAddress();
     ...
     */
    public String allowUserToConnect(String par1SocketAddress, String par2Str)
    {
        ...
        {
            String var3 = par1SocketAddress == null ? "" : par1SocketAddress;
            int var3Slash = var3.indexOf("/");
            if (var3Slash >= 0)
            {
                var3 = var3.substring(var3Slash + 1);
            }

            int var3Colon = var3.indexOf(":");
            if (var3Colon >= 0)
            {
                var3 = var3.substring(0, var3Colon);
            }

            if (var3.length() > 0 && this.bannedIPs.isBanned(var3))
            {
