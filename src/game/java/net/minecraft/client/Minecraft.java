...
public class Minecraft implements Runnable, IPlayerUsage
{
    ...
    public void startGame() throws LWJGLException
    {
        ...
        {
            String name = EaglerProfile.getName();
            if (name == null || name.length() == 0)
            {
                name = "Player";
            }
            this.session = new Session(name, "local");
        }
        ...
        this.standardGalacticFontRenderer = EaglerFontRenderer.createSupportedFontRenderer(this.gameSettings, "/font/alternate.png", this.renderEngine);
    ...
    public void run()
    {
        ...
        {
            throw new RuntimeException("Failed to start game", var11);
        }
        ...
        try
        {
            while (this.running)
            {
                ...
                Display.update(EntityRenderer.func_78465_a(this.gameSettings.limitFramerate));

                if (Display.wasResized())
                {
                    int var16 = Display.getWidth();
                    int var17 = Display.getHeight();
                    if (var16 <= 0)
                    {
                        var16 = 1;
                    }
        ...
        catch (ReportedException var13)
        {
            ...
            this.freeMemory();
            EagRuntime.debugPrintStackTraceToSTDERR(var13);
        ...
        catch (Throwable var14)
        {
            ...
            this.freeMemory();
            EagRuntime.debugPrintStackTraceToSTDERR(var14);
    ...
    /**
     * Toggles fullscreen and updates cached size.
     */
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper var1) {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'addServerStatsToSnooper'");
    }

    @Override
    public void addServerTypeToSnooper(PlayerUsageSnooper var1) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'addServerTypeToSnooper'");
    }
}
