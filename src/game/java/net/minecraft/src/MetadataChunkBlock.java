						...
						for(int var8 = this.field_1304_c; var8 <= this.field_1301_f; ++var8) {
							if(var8 >= 0 && var8 < 128) {
								...
								if(var9 != var20) {
									...
									var1.updateLightByType(this.field_1299_a, var6 - 1, var8, var7);
									var1.updateLightByType(this.field_1299_a, var6, var8 - 1, var7);
									var1.updateLightByType(this.field_1299_a, var6, var8, var7 - 1);
