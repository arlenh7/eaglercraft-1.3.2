...
public class Block
{
    ...
    public static final Block signPost = (new BlockSign(63, TileEntitySign::new, true)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign").disableStats().setRequiresSelfNotify();
    ...
    public static final Block signWall = (new BlockSign(68, TileEntitySign::new, false)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign").disableStats().setRequiresSelfNotify();
     ...
     */
    public MovingObjectPosition collisionRayTrace(World par1World, int par2, int par3, int par4, Vec3D var5, Vec3D var6)
    {
        this.setBlockBoundsBasedOnState(par1World, par2, par3, par4);
        var5 = var5.addVector((double)(-par2), (double)(-par3), (double)(-par4));
        var6 = var6.addVector((double)(-par2), (double)(-par3), (double)(-par4));
        Vec3 var7 = (Vec3) var5.getIntermediateWithXValue(var6, this.minX);
   ...
   public MovingObjectPosition collisionRayTrace(World par1World, int par2, int par3, int par4, Vec3 var5, Vec3 var6)
    {
        this.setBlockBoundsBasedOnState(par1World, par2, par3, par4);
        var5 = var5.addVector((double)(-par2), (double)(-par3), (double)(-par4));
        var6 = var6.addVector((double)(-par2), (double)(-par3), (double)(-par4));
