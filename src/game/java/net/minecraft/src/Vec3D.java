...
public class Vec3D {
	...
	public double squareDistanceTo(Vec3 var7) {
		double var2 = var7.xCoord - this.xCoord;
		double var4 = var7.yCoord - this.yCoord;
		double var6 = var7.zCoord - this.zCoord;
	...
	public Vec3 getIntermediateWithXValue(Vec3D var1, double var2) {
		...
		if(var4 * var4 < (double)1.0E-7F) {
			...
			return var10 >= 0.0D && var10 <= 1.0D ? Vec3.getVec3Pool().getVecFromPool(this.xCoord + var4 * var10, this.yCoord + var6 * var10, this.zCoord + var8 * var10) : null;
		}
	}

	public Vec3 getIntermediateWithYValue(Vec3D var1, double var2) {
		double var4 = var1.xCoord - this.xCoord;
		double var6 = var1.yCoord - this.yCoord;
		double var8 = var1.zCoord - this.zCoord;
	...
	public Vec3 getIntermediateWithZValue(Vec3D var1, double var2) {
		double var4 = var1.xCoord - this.xCoord;
		double var6 = var1.yCoord - this.yCoord;
		double var8 = var1.zCoord - this.zCoord;
