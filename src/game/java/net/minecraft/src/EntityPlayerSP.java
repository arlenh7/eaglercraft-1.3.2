...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        // Disable legacy skin downloads (skins.minecraft.net is defunct); use default texture instead.
        this.skinUrl = null;
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            if (this.inPortal)
            {
                ...
                {
                    this.mc.sndManager.playSound("portal.trigger", 1.0F, this.rand.nextFloat() * 0.4F + 0.8F, this.rand.nextFloat(), this.rand.nextFloat(), this.rand.nextFloat());
                }
    ...
    {
        // Disable legacy cloak downloads; use no cloak by default.
