...
public class MathHelper
{
     ...
     */
    public static int clamp(int par0, int par1, int par2)
    {
        return clamp_int(par0, par1, par2);
    }

    /**
     * Returns the value of the first parameter, clamped to be within the lower and upper limits.
     */
    public static float clamp(float par0, float par1, float par2)
    {
        return clamp_float(par0, par1, par2);
    }

    private static final int[] DEBRUIJN_TABLE = new int[]
    {
        0, 1, 28, 2, 29, 14, 24, 3,
    ...
    public static boolean isPowerOfTwo(int par0)
    {
        return par0 > 0 && (par0 & par0 - 1) == 0;
    }

    public static int roundUpToPowerOfTwo(int par0)
    {
        int var0 = par0 - 1;
        var0 |= var0 >> 1;
        var0 |= var0 >> 2;
    ...
    public static int log2DeBruijn(int par0)
    {
        if (par0 <= 0)
        {
            return 0;
        ...
        int var0 = isPowerOfTwo(par0) ? par0 : roundUpToPowerOfTwo(par0);
        return DEBRUIJN_TABLE[(int)((long)var0 * 125613361L >> 27) & 31];
    }
