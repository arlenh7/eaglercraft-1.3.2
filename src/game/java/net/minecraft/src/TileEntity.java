...
public class TileEntity
{
    ...
    /** Supplier mappings to avoid reflection */
    private static Map<String, TileEntitySupplier<? extends TileEntity>> nameToSupplierMap = new HashMap();
    private static Map<Class<? extends TileEntity>, TileEntitySupplier<? extends TileEntity>> classToSupplierMap = new HashMap();
     ...
     */
    private static void addMapping(Class<? extends TileEntity> par0Class, TileEntitySupplier<? extends TileEntity> supplier, String par1Str)
    {
        ...
        else
        {
            ...
            nameToSupplierMap.put(par1Str, supplier);
            classToSupplierMap.put(par0Class, supplier);
        }
    }
    ...
    public static TileEntity createAndLoadEntity(NBTTagCompound par0NBTTagCompound)
    {
        ...
        try
        {
            TileEntitySupplier<? extends TileEntity> var2 = nameToSupplierMap.get(par0NBTTagCompound.getString("id"));
