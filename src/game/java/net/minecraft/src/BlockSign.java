...
{
    private TileEntitySupplier<? extends TileEntity> signEntitySupplier;

    /** Whether this is a freestanding sign or a wall-mounted sign */
    private boolean isFreestanding;

    protected BlockSign(int par1, TileEntitySupplier<? extends TileEntity> par2Supplier, boolean par3)
    {
        super(par1, Material.wood);
        this.isFreestanding = par3;
        this.blockIndexInTexture = 4;
        this.signEntitySupplier = par2Supplier;
        float var4 = 0.25F;
        float var5 = 1.0F;
    ...
    {
        return this.signEntitySupplier.createTileEntity();
    }
